---
title: "Ulbrich et al. Greenhouse exp Bacterial Community Analyses"
...
Lukas (lukas.dereske@gmail.com) processed the sequences and subset the larger run to only have samples from MERDS (MERDs 56 of 317 samples in the run)
...
WU_pair_trans_mod_pres= lmer(w_unifrac~s1_precip*s1_soil_root+(1|sample2), data= SILVA_MERDS_rar_WU_dis_wi_bl_trans_pres)
...
df_anova_WU_pair_trans_mod_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Precip.*Mic.Pres."),"Df"=anova_WU_pair_trans_mod_pres$NumDF,"Resid Df"=anova_WU_pair_trans_mod_pres$DenDF,"F-value"=anova_WU_pair_trans_mod_pres$`F value`,"P-value"=anova_WU_pair_trans_mod_pres$`Pr(>F)`)
kable(df_anova_WU_pair_trans_mod_pres,align = "c",digits = c(1,2,2,3), caption= "Trans Distance to initial soil communtiy")
```

#### Microhabitat Distance from start community seedling
...
WU_pair_trans_mod= lmer(w_unifrac~s1_precip*s1_soil_root+(1|sample2), data= SILVA_MERDS_rar_WU_dis_wi_bl_trans)
...
df_anova_WU_pair_trans_mod=data.frame(row.names =c("Precipitation","Microbial Source","Precip.*Mic.Source"),"Df"=anova_WU_pair_trans_mod$NumDF,"Resid Df"=anova_WU_pair_trans_mod$DenDF,"F-value"=anova_WU_pair_trans_mod$`F value`,"P-value"=anova_WU_pair_trans_mod$`Pr(>F)`)
...
#15
WU_pair_seed_mod_pres= lmer(w_unifrac~s1_precip*s1_soil_root+(1|sample2), data= SILVA_MERDS_rar_WU_dis_wi_bl_seed_pres)
...
df_anova_WU_pair_seed_mod_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Precip.*Mic.Pres."),"Df"=anova_WU_pair_seed_mod_pres$NumDF,"Resid Df"=anova_WU_pair_seed_mod_pres$DenDF,"F-value"=anova_WU_pair_seed_mod_pres$`F value`,"P-value"=anova_WU_pair_seed_mod_pres$`Pr(>F)`)
...
WU_pair_seed_mod= lmer(w_unifrac~s1_precip*s1_soil_root+(1|sample2), data= SILVA_MERDS_rar_WU_dis_wi_bl_seed)
...
df_anova_WU_pair_seed_mod=data.frame(row.names =c("Precipitation","Microbial Source","Precip.*Mic.Source"),"Df"=anova_WU_pair_seed_mod$NumDF,"Resid Df"=anova_WU_pair_seed_mod$DenDF,"F-value"=anova_WU_pair_seed_mod$`F value`,"P-value"=anova_WU_pair_seed_mod$`Pr(>F)`)
...
adonis2(SILVA_MERDS_rar_start_WU_dis~SILVA_MERDS_rar_start_map$root_association,permutations = 9999)
```
...
plot_ordination(SILVA_MERDS_rar_NS,SILVA_MERDS_rar_NS_WU_ord, color="root_association",shape="life_stage")+geom_point(size=3)+
  theme_bw()
#Treatment factors 
#write.csv(data.frame(sample_data(SILVA_MERDS_rar_NS))[c("precip","block","soil_root","root_association","soil_status","life_stage")],here::here("R_data","SILVA_MERDS_rar_NS_map.csv"))
#distance file 
#write.csv(as.matrix(distance(SILVA_MERDS_rar_NS,method = "wunifrac")),here::here("R_data","Weight_Uni_SILVA_MERDS_rar_NS_dist.csv"))
```
...
(trans_ord_p=ggplot(data=SILVA_MERDS_rar_trans_ord_WU_points, aes(x=MDS1,y=MDS2))+
   ...
   annotate("label",x=-0.10,y=0.12, size=8,
            label=paste("Stress =", signif(SILVA_MERDS_rar_seed_WU_ord$stress,digits = 3)))+
...
(live_trans_ord_p=ggplot(data=SILVA_MERDS_rar_live_trans_ord_WU_points, aes(x=MDS1,y=MDS2))+
   ...
   annotate("label",x=-0.131,y=0.05, size=8,
            label=paste("Stress =", signif(SILVA_MERDS_rar_live_trans_WU_ord$stress,digits = 3)))+
    theme(axis.title = element_text(size = 20),axis.text = element_text(size = 18),legend.position = "none",
          panel.grid.major = element_blank(), panel.grid.minor = element_blank()))
...
##### Graph without initial community
...
#Treatment factors 
#write.csv(data.frame(sample_data(SILVA_MERDS_rar_trt_trans))[c("precip","block","soil_root","root_association","soil_status")],here::here("R_data","trans_SILVA_MERDS_rar_live_NS_map.csv"))
#distance file 
#write.csv(as.matrix(distance(SILVA_MERDS_rar_trt_trans,method = "wunifrac")),here::here("R_data","trans_Weight_Uni_SILVA_MERDS_rar_live_NS_dist.csv"))
```
...
(trans_ord_p=ggplot(data=SILVA_MERDS_rar_seed_ord_WU_points, aes(x=MDS1,y=MDS2))+
    geom_point(size=7, stroke=1.5,aes(shape=soil_root, fill=precip))+
    theme_bw()+xlab("NMDS1")+ylab("NMDS2")+
   annotate("label",x=-0.10,y=0.1, size=8,
            label=paste("Stress =", signif(SILVA_MERDS_rar_seed_WU_ord$stress,digits = 3)))+
    scale_shape_manual(values = c(21,23,24))+scale_fill_manual(values = c("Red1","cyan3","black"))+
    theme(axis.title = element_text(size = 20),axis.text = element_text(size = 18),legend.position = "none",
          panel.grid.major = element_blank(), panel.grid.minor = element_blank()))
...
(live_seed_ord_p=ggplot(data=SILVA_MERDS_rar_live_seed_ord_WU_points, aes(x=MDS1,y=MDS2))+
    geom_point(size=10, stroke=1.5,aes(shape=root_association, fill=precip))+
    theme_bw()+xlab("NMDS1")+ylab("NMDS2")+
   annotate("label",x=-0.075,y=0.052, size=8,
            label=paste("Stress =", signif(SILVA_MERDS_rar_live_seed_WU_ord$stress,digits = 3)))+
    scale_shape_manual(values = c(21,24))+scale_fill_manual(values = c("Red1","cyan3","black"))+
    theme(axis.title = element_text(size = 20),axis.text = element_text(size = 18),legend.position = "none",
          panel.grid.major = element_blank(), panel.grid.minor = element_blank()))
...
#save(live_NS_seed.ind,file = here::here("R_data","Indicator_spp_live_no_start_seed_comm_association.Rdata"))
...
##### Graph without the initial community
...
plot_ordination(SILVA_MERDS_rar_trt_seed,SILVA_MERDS_rar_trt_seed_WU_ord, color="precip",shape="soil_root")+geom_point(size=4)+
  geom_label_repel(size=3,aes(label = block))+theme_bw()
#Treatment factors 
#write.csv(data.frame(sample_data(SILVA_MERDS_rar_trt_seed))[c("precip","block","soil_root","root_association","soil_status")],here::here("R_data","seed_SILVA_MERDS_rar_live_NS_map.csv"))
#distance file 
#write.csv(as.matrix(distance(SILVA_MERDS_rar_trt_seed,method = "wunifrac")),here::here("R_data","seed_Weight_Uni_SILVA_MERDS_rar_live_NS_dist.csv"))
```
...
df_anova_bact_obs_rich_model_start=data.frame(row.names ="Microbial treatment","Df"=anova_bact_obs_rich_model_start$NumDF,"Resid Df"=anova_bact_obs_rich_model_start$DenDF,"F-value"=anova_bact_obs_rich_model_start$`F value`,"P-value"=anova_bact_obs_rich_model_start$`Pr(>F)`)
...
df_anova_bact_InvSimp_model_start=data.frame(row.names ="Microbial treatment","Df"=anova_bact_InvSimp_model_start$NumDF,"Resid Df"=anova_bact_InvSimp_model_start$DenDF,"F-value"=anova_bact_InvSimp_model_start$`F value`,"P-value"=anova_bact_InvSimp_model_start$`Pr(>F)`)
...
Diagnostic Graphs
```{r}
bact_obs_rich_model_trans= lmer((Observed)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_trt_trans)
...
df_anova_bact_obs_rich_model_trans=data.frame(row.names =c("Precipitation","Microbial treatment","Precip.*Mic.Treat."),"Df"=anova_bact_obs_rich_model_trans$NumDF,"Resid Df"=anova_bact_obs_rich_model_trans$DenDF,"F-value"=anova_bact_obs_rich_model_trans$`F value`,"P-value"=anova_bact_obs_rich_model_trans$`Pr(>F)`)
...
bact_obs_rich_model_trans_pres= lmer((Observed)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_pres_trans)
...
df_anova_bact_obs_rich_model_trans_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Precip.*Mic.Pres."),"Df"=anova_bact_obs_rich_model_trans_pres$NumDF,"Resid Df"=anova_bact_obs_rich_model_trans_pres$DenDF,"F-value"=anova_bact_obs_rich_model_trans_pres$`F value`,"P-value"=anova_bact_obs_rich_model_trans_pres$`Pr(>F)`)
...
bact_obs_rich_model_trans_orig= lmer((Observed)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_orig_trans)
...
df_anova_bact_obs_rich_model_trans_orig=data.frame(row.names =c("Precipitation","Microbial Source","Precip.*Mic.Source"),"Df"=anova_bact_obs_rich_model_trans_orig$NumDF,"Resid Df"=anova_bact_obs_rich_model_trans_orig$DenDF,"F-value"=anova_bact_obs_rich_model_trans_orig$`F value`,"P-value"=anova_bact_obs_rich_model_trans_orig$`Pr(>F)`)
...
Diagnostic Graphs
```{r}
bact_inv_simp_model_trans= lmer((InvSimpson)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_trt_trans)
...
df_anova_bact_inv_simp_model_trans=data.frame(row.names =c("Precipitation","Microbial treatment","Precip.*Mic.Treat."),"Df"=anova_bact_inv_simp_model_trans$NumDF,"Resid Df"=anova_bact_inv_simp_model_trans$DenDF,"F-value"=anova_bact_inv_simp_model_trans$`F value`,"P-value"=anova_bact_inv_simp_model_trans$`Pr(>F)`)
...
bact_inv_simp_model_trans_pres= lmer((InvSimpson)^(-1/2)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_pres_trans)
...
df_anova_bact_inv_simp_model_trans_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Precip.*Mic.Pres."),"Df"=anova_bact_inv_simp_model_trans_pres$NumDF,"Resid Df"=anova_bact_inv_simp_model_trans_pres$DenDF,"F-value"=anova_bact_inv_simp_model_trans_pres$`F value`,"P-value"=anova_bact_inv_simp_model_trans_pres$`Pr(>F)`)
...
### Microhabitat inv Simpson

Diagnostic Graphs
```{r}
SILVA_MERDS_rar.divfil_orig_trans=subset(SILVA_MERDS_rar.divfil_trt_trans, soil_status =="L")

bact_inv_simp_model_trans_orig= lmer((InvSimpson)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_orig_trans)
...
df_anova_bact_inv_simp_model_trans_orig=data.frame(row.names =c("Precipitation","Microbial Source","Precip.*Mic.Source"),"Df"=anova_bact_inv_simp_model_trans_orig$NumDF,"Resid Df"=anova_bact_inv_simp_model_trans_orig$DenDF,"F-value"=anova_bact_inv_simp_model_trans_orig$`F value`,"P-value"=anova_bact_inv_simp_model_trans_orig$`Pr(>F)`)
...
Diagnostic Graphs
```{r}
bact_obs_rich_model_seed= lmer(log(Observed)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_trt_seed)
...
df_anova_bact_obs_rich_model_seed=data.frame(row.names =c("Precipitation","Microbial treatment","Precip.*Mic.Treat."),"Df"=anova_bact_obs_rich_model_seed$NumDF,"Resid Df"=anova_bact_obs_rich_model_seed$DenDF,"F-value"=anova_bact_obs_rich_model_seed$`F value`,"P-value"=anova_bact_obs_rich_model_seed$`Pr(>F)`)
...
paste("Percentage difference =",((obs_rich_start_seed[obs_rich_start_seed$life_stage=="S"&obs_rich_start_seed$soil_root=="L.B",]$mean-obs_rich_start_seed[obs_rich_start_seed$life_stage=="Start"&obs_rich_start_seed$soil_root=="L.B",]$mean)/obs_rich_start_seed[obs_rich_start_seed$life_stage=="Start"&obs_rich_start_seed$soil_root=="L.B",]$mean)*100)
...
paste("Percentage difference =",((obs_rich_start_seed[obs_rich_start_seed$life_stage=="S"&obs_rich_start_seed$soil_root=="L.R",]$mean-obs_rich_start_seed[obs_rich_start_seed$life_stage=="Start"&obs_rich_start_seed$soil_root=="L.R",]$mean)/obs_rich_start_seed[obs_rich_start_seed$life_stage=="Start"&obs_rich_start_seed$soil_root=="L.R",]$mean)*100)
...
bact_obs_rich_model_seed_pres= lmer((Observed)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_pres_seed)
...
bact_obs_rich_model_seed_orig= lmer((Observed)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_orig_seed)
...
df_anova_bact_obs_rich_model_seed_orig=data.frame(row.names =c("Precipitation","Microbial Source","Precip.*Mic.Source"),"Df"=anova_bact_obs_rich_model_seed_orig$NumDF,"Resid Df"=anova_bact_obs_rich_model_seed_orig$DenDF,"F-value"=anova_bact_obs_rich_model_seed_orig$`F value`,"P-value"=anova_bact_obs_rich_model_seed_orig$`Pr(>F)`)
...
Diagnostic Graphs
```{r}
bact_inv_simp_model_seed= lmer(log(InvSimpson)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_trt_seed)
...
df_anova_bact_inv_simp_model_seed=data.frame(row.names =c("Precipitation","Microbial treatment","Precip.*Mic.Treat."),"Df"=anova_bact_inv_simp_model_seed$NumDF,"Resid Df"=anova_bact_inv_simp_model_seed$DenDF,"F-value"=anova_bact_inv_simp_model_seed$`F value`,"P-value"=anova_bact_inv_simp_model_seed$`Pr(>F)`)
...
bact_inv_simp_model_seed_pres= lmer(log(InvSimpson)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_pres_seed)
...
df_anova_bact_inv_simp_model_seed_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Precip.*Mic.Pres."),"Df"=anova_bact_inv_simp_model_seed_pres$NumDF,"Resid Df"=anova_bact_inv_simp_model_seed_pres$DenDF,"F-value"=anova_bact_inv_simp_model_seed_pres$`F value`,"P-value"=anova_bact_inv_simp_model_seed_pres$`Pr(>F)`)
...
bact_inv_simp_model_seed_orig= lmer((InvSimpson)~precip*soil_root+(1|block), data= SILVA_MERDS_rar.divfil_orig_seed)
...
df_anova_bact_inv_simp_model_seed_orig=data.frame(row.names =c("Precipitation","Microbial Source","Precip.*Mic.Source"),"Df"=anova_bact_inv_simp_model_seed_orig$NumDF,"Resid Df"=anova_bact_inv_simp_model_seed_orig$DenDF,"F-value"=anova_bact_inv_simp_model_seed_orig$`F value`,"P-value"=anova_bact_inv_simp_model_seed_orig$`Pr(>F)`)
...
Diagnostic Graphs
```{r}
bact_obs_rich_model_comb= lmer(log(Observed)~precip*soil_root*life_stage+(1|block), data= SILVA_MERDS_rar.divfil_trt)
...
df_anova_bact_obs_rich_model_comb=data.frame(row.names =c("Precipitation","Microbial treatment","Life-stage","Precip.*Mic.Treat.","Precip.*Life-stage","Mic.Treat.*Life-stage","Precip.*Mic.Treat.*Life-stage"),"Df"=anova_bact_obs_rich_model_comb$NumDF,"Resid Df"=anova_bact_obs_rich_model_comb$DenDF,"F-value"=anova_bact_obs_rich_model_comb$`F value`,"P-value"=anova_bact_obs_rich_model_comb$`Pr(>F)`)
...
bact_obs_rich_model_comb_pres= lmer(log(Observed)~precip*soil_root*life_stage+(1|block), data= SILVA_MERDS_rar.divfil_pres_comb)
...
df_anova_bact_obs_rich_model_comb_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Life-stage","Precip.*Mic.Pres.","Precip.*Life-stage","Mic.Pres.*Life-stage","Precip.*Mic.Pres.*Life-stage"),"Df"=anova_bact_obs_rich_model_comb_pres$NumDF,"Resid Df"=anova_bact_obs_rich_model_comb_pres$DenDF,"F-value"=anova_bact_obs_rich_model_comb_pres$`F value`,"P-value"=anova_bact_obs_rich_model_comb_pres$`Pr(>F)`)
...
bact_obs_rich_model_comb_orig= lmer((Observed)~precip*soil_root*life_stage+(1|block), data= SILVA_MERDS_rar.divfil_orig_comb)
...
df_anova_bact_obs_rich_model_comb_orig=data.frame(row.names =c("Precipitation","Microbial Source","Life-stage","Precip.*Mic.Source","Precip.*Life-stage","Mic.Source*Life-stage","Precip.*Mic.Source*Life-stage"),"Df"=anova_bact_obs_rich_model_comb_orig$NumDF,"Resid Df"=anova_bact_obs_rich_model_comb_orig$DenDF,"F-value"=anova_bact_obs_rich_model_comb_orig$`F value`,"P-value"=anova_bact_obs_rich_model_comb_orig$`Pr(>F)`)
...
Diagnostic Graphs
```{r}
bact_inv_simp_model_comb= lmer(log(InvSimpson)~precip*soil_root*life_stage+(1|block), data= SILVA_MERDS_rar.divfil_trt)
...
df_anova_bact_inv_simp_model_comb=data.frame(row.names =c("Precipitation","Microbial treatment","Life-stage","Precip.*Mic.Treat.","Precip.*Life-stage","Mic.Treat.*Life-stage","Precip.*Mic.Treat.*Life-stage"),"Df"=anova_bact_inv_simp_model_comb$NumDF,"Resid Df"=anova_bact_inv_simp_model_comb$DenDF,"F-value"=anova_bact_inv_simp_model_comb$`F value`,"P-value"=anova_bact_inv_simp_model_comb$`Pr(>F)`)
...
bact_inv_simp_model_comb_pres= lmer(log(InvSimpson)~precip*soil_root*life_stage+(1|block), data= SILVA_MERDS_rar.divfil_pres_comb)
...
df_anova_bact_inv_simp_model_comb_pres=data.frame(row.names =c("Precipitation","Microbial Presence","Life-stage","Precip.*Mic.Pres.","Precip.*Life-stage","Mic.Pres.*Life-stage","Precip.*Mic.Pres.*Life-stage"),"Df"=anova_bact_inv_simp_model_comb_pres$NumDF,"Resid Df"=anova_bact_inv_simp_model_comb_pres$DenDF,"F-value"=anova_bact_inv_simp_model_comb_pres$`F value`,"P-value"=anova_bact_inv_simp_model_comb_pres$`Pr(>F)`)
...
bact_inv_simp_model_comb_orig= lmer((InvSimpson)~precip*soil_root*life_stage+(1|block), data= SILVA_MERDS_rar.divfil_orig_comb)
...
df_anova_bact_inv_simp_model_comb_orig=data.frame(row.names =c("Precipitation","Microbial Source","Life-stage","Precip.*Mic.Source","Precip.*Life-stage","Mic.Source*Life-stage","Precip.*Mic.Source*Life-stage"),"Df"=anova_bact_inv_simp_model_comb_orig$NumDF,"Resid Df"=anova_bact_inv_simp_model_comb_orig$DenDF,"F-value"=anova_bact_inv_simp_model_comb_orig$`F value`,"P-value"=anova_bact_inv_simp_model_comb_orig$`Pr(>F)`)
