---
title: "Ulbrich et al. Code for climate history (SPEI) of soil sampling dates"
...
### Code is based on the below databases and protocols
...
#Below must be downloaded
Global_SPEI_nc_tidy <- tidync(here::here("R_data","spei01.nc"))# 1 Month SPEI downloaded from doi:10.5281/zenodo.834462
print(Global_SPEI_nc_tidy)
```

# Extract the SPEI for GLBRC Biofuel Cropping System Experiment
