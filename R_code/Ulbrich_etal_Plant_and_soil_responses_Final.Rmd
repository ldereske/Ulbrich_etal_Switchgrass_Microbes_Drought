...
```
# SEED GERMINATION PORTION OF THE EXPERIMENT BEGINS
...
((germ_soil_root[germ_soil_root$soil_root=="L.B",]$mean-germ_soil_root[germ_soil_root$soil_root=="S.B",]$mean)/germ_soil_root[germ_soil_root$soil_root=="S.B",]$mean)*100


(germ_soil_root[germ_soil_root$soil_root=="L.B",]$mean-germ_soil_root[germ_soil_root$soil_root=="S.B",]$mean)
...
germ_soil_root_precip[germ_soil_root_precip$precip=="A"&germ_soil_root_precip$soil_root=="L.B",]$mean-germ_soil_root_precip[germ_soil_root_precip$precip=="A"&germ_soil_root_precip$soil_root=="S.B",]$mean
...
#number of germinants
germ_soil_precip[germ_soil_precip$precip=="D",]$mean-germ_soil_precip[germ_soil_precip$precip=="A",]$mean
...
((seed_surv_soil_root[seed_surv_soil_root$soil_root=="L.B",]$mean-seed_surv_soil_root[seed_surv_soil_root$soil_root=="S.B",]$mean)/seed_surv_soil_root[seed_surv_soil_root$soil_root=="S.B",]$mean)*100
...
### Origin survival of the Seedling####
...
((SG_ammonium_N_trt_LS_trt[SG_ammonium_N_trt_LS_trt$soil_root=="S.B",]$mean-SG_ammonium_N_trt_LS_trt[SG_ammonium_N_trt_LS_trt$soil_root=="L.B",]$mean)/SG_ammonium_N_trt_LS_trt[SG_ammonium_N_trt_LS_trt$soil_root=="L.B",]$mean)*100
```

### Origin ammonium Seedling
...
```{r}
#Change in NO3
(mean(SG_inorg_N_trt$ug_N_NO3_g_dry_soil)-mean(SG_start_inorg_N$ug_N_NO3_g_dry_soil))/mean(SG_start_inorg_N$ug_N_NO3_g_dry_soil)

#Change in NH4
(mean(SG_inorg_N_trt$ug_N_NH4_g_dry_soil)-mean(SG_start_inorg_N$ug_N_NH4_g_dry_soil))/mean(SG_start_inorg_N$ug_N_NH4_g_dry_soil)
...
(soil_amm_START_trt[soil_amm_START_trt$soil_root=="S.B",]$mean-soil_amm_START_trt[soil_amm_START_trt$soil_root=="L.B",]$mean)/soil_amm_START_trt[soil_amm_START_trt$soil_root=="L.B",]$mean
#5.685818
