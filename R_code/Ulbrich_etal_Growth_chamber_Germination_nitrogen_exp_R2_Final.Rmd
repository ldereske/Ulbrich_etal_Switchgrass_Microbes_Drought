---
title: "Ulbrich et al. Growthchamber exp Plant Responses Data Analyses"
...
df_anova_lm.GermDay12=data.frame(row.names =c("(Intercept)","Microbial Presence","Nitrogen","Shelf","Nitr.*Mic.Presence","Residuals"),"Df"=anova_lm.GermDay12$Df,"F-value"=anova_lm.GermDay12$`F value`,"P-value"=anova_lm.GermDay12$`Pr(>F)`)
...
paste("Percentage difference =",((germdata_N_level[germdata_N_level$Nitrogen_Treatment=="High",]$mean-germdata_N_level[germdata_N_level$Nitrogen_Treatment=="Low",]$mean)/germdata_N_level[germdata_N_level$Nitrogen_Treatment=="Low",]$mean)*100)


paste("Number of germinants =",germdata_N_level[germdata_N_level$Nitrogen_Treatment=="High",]$mean-germdata_N_level[germdata_N_level$Nitrogen_Treatment=="Low",]$mean)
...
#Neither has a significant effect
```
...
df_anova_lm.GermPerGerminant_shoot_dry_g=data.frame(row.names =c("(Intercept)","Microbial Presence","Nitrogen","Shelf","Nitr.*Mic.Presence","Residuals"),"Df"=anova_lm.GermPerGerminant_shoot_dry_g$Df,"F-value"=anova_lm.GermPerGerminant_shoot_dry_g$`F value`,"P-value"=anova_lm.GermPerGerminant_shoot_dry_g$`Pr(>F)`)
...
#Percentage Difference
paste("Nitrogen trt: Percentage difference =",((germdata_N_level_biomass[germdata_N_level_biomass$Nitrogen_Treatment=="High",]$mean-germdata_N_level_biomass[germdata_N_level_biomass$Nitrogen_Treatment=="Low",]$mean)/germdata_N_level_biomass[germdata_N_level_biomass$Nitrogen_Treatment=="Low",]$mean)*100)


paste("Nitrogen trt: Number of germinants =",germdata_N_level_biomass[germdata_N_level_biomass$Nitrogen_Treatment=="High",]$mean-germdata_N_level_biomass[germdata_N_level_biomass$Nitrogen_Treatment=="Low",]$mean)
...
#Percentage Difference
paste("Microbial trt: Percentage difference =",((germdata_soil_status_biomass[germdata_soil_status_biomass$Soil_Treatment=="Sterile",]$mean-germdata_soil_status_biomass[germdata_soil_status_biomass$Soil_Treatment=="Live",]$mean)/germdata_soil_status_biomass[germdata_soil_status_biomass$Soil_Treatment=="Live",]$mean)*100)


paste("Microbial trt: Number of germinants =",germdata_soil_status_biomass[germdata_soil_status_biomass$Soil_Treatment=="Sterile",]$mean-germdata_soil_status_biomass[germdata_soil_status_biomass$Soil_Treatment=="Live",]$mean)
