...
df_anova_day_t0_germ_model_orig=data.frame(row.names =c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_day_t0_germ_model_orig$NumDF,"Resid Df"=anova_day_t0_germ_model_orig$DenDF,"F-value"=anova_day_t0_germ_model_orig$`F value`,"P-value"=anova_day_t0_germ_model_orig$`Pr(>F)`)
...
df_Anova_seed_germ_model_org=data.frame(row.names =c("(Intercept)","Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=Anova_seed_germ_model_org$Df,"Chi-Sq"=Anova_seed_germ_model_org$Chisq,"P-value"=Anova_seed_germ_model_org$`Pr(>Chisq)`)
...
df_Anova_seed_final_plant_no_model_orig=data.frame(row.names =c("(Intercept)","Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=Anova_seed_final_plant_no_model_orig$Df,"Chi-Sq"=Anova_seed_final_plant_no_model_orig$Chisq,"P-value"=Anova_seed_final_plant_no_model_orig$`Pr(>Chisq)`)
...
df_Anova_seed_surv_germ_model_orig=data.frame(row.names =c("(Intercept)","Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=Anova_seed_surv_germ_model_orig$Df,"Chi-Sq"=Anova_seed_surv_germ_model_orig$Chisq,"P-value"=Anova_seed_surv_germ_model_orig$`Pr(>Chisq)`)
...
df_anova_seed_biomas_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_seed_biomas_model_orig$NumDF,"Resid Df"=anova_seed_biomas_model_orig$DenDF,"F-value"=anova_seed_biomas_model_orig$`F value`,"P-value"=anova_seed_biomas_model_orig$`Pr(>F)`)
...
df_anova_root_shoot_seed_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_root_shoot_seed_model_orig$NumDF,"Resid Df"=anova_root_shoot_seed_model_orig$DenDF,"F-value"=anova_root_shoot_seed_model_orig$`F value`,"P-value"=anova_root_shoot_seed_model_orig$`Pr(>F)`)
...
df_anova_trans_biomas_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_trans_biomas_model_orig$NumDF,"Resid Df"=anova_trans_biomas_model_orig$DenDF,"F-value"=anova_trans_biomas_model_orig$`F value`,"P-value"=anova_trans_biomas_model_orig$`Pr(>F)`)
...
df_anova_root_shoot_model_orig_na=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_root_shoot_model_orig_na$NumDF,"Resid Df"=anova_root_shoot_model_orig_na$DenDF,"F-value"=anova_root_shoot_model_orig_na$`F value`,"P-value"=anova_root_shoot_model_orig_na$`Pr(>F)`)
...
df_Anova_drought_surv_model_orig=data.frame(row.names =c("(Intercept)","Microbial Inocula"),"Df"=Anova_drought_surv_model_orig$Df,"Chi-Sq"=Anova_drought_surv_model_orig$Chisq,"P-value"=Anova_drought_surv_model_orig$`Pr(>Chisq)`)
...
df_anova_SRL_trans_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_SRL_trans_model_orig$NumDF,"Resid Df"=anova_SRL_trans_model_orig$DenDF,"F-value"=anova_SRL_trans_model_orig$`F value`,"P-value"=anova_SRL_trans_model_orig$`Pr(>F)`)
...
df_anova_rhizosheath_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_rhizosheath_model_orig$NumDF,"Resid Df"=anova_rhizosheath_model_orig$DenDF,"F-value"=anova_rhizosheath_model_orig$`F value`,"P-value"=anova_rhizosheath_model_orig$`Pr(>F)`)
...
df_anova_SG_soil_nit_trans_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_SG_soil_nit_trans_model_orig$NumDF,"Resid Df"=anova_SG_soil_nit_trans_model_orig$DenDF,"F-value"=anova_SG_soil_nit_trans_model_orig$`F value`,"P-value"=anova_SG_soil_nit_trans_model_orig$`Pr(>F)`)
...
df_anova_SG_soil_amm_trans_model_orig=data.frame(row.names = c("Precipitation","Microbial Inocula","Precip.*Mic.Inoc."),"Df"=anova_SG_soil_amm_trans_model_orig$NumDF,"Resid Df"=anova_SG_soil_amm_trans_model_orig$DenDF,"F-value"=anova_SG_soil_amm_trans_model_orig$`F value`,"P-value"=anova_SG_soil_amm_trans_model_orig$`Pr(>F)`)
...
df_Anova_SG_Soil_nit_start_orig=data.frame(row.names =c("(Intercept)","Microbial Inocula", "Block","Residuals"),"Df"=Anova_SG_Soil_nit_start_orig$Df,"F-value"=Anova_SG_Soil_nit_start_orig$`F value`,"P-value"=Anova_SG_Soil_nit_start_orig$`Pr(>F)`)
...
df_Anova_SG_Soil_amm_start_orig=data.frame(row.names =c("(Intercept)","Microbial Inocula", "Block","Residuals"),"Df"=Anova_SG_Soil_amm_start_orig$Df,"F-value"=Anova_SG_Soil_amm_start_orig$`F value`,"P-value"=Anova_SG_Soil_amm_start_orig$`Pr(>F)`)
...
Anova_SG_combin_surv_drought_orig_model=data.frame(row.names =c("(Intercept)","Microbial Inocula","Life-stage","Mic.Inoc.*Life-stage"),"Df"=Anova_SG_combin_surv_drought_orig_model$Df,"Chi-Sq"=Anova_SG_combin_surv_drought_orig_model$Chisq,"P-value"=Anova_SG_combin_surv_drought_orig_model$`Pr(>Chisq)`)
...
df_anova_SG_combin_biomass_orig_model=data.frame(row.names = c("Microbial Inocula","Precipitation","Life-stage","Precip.*Mic.Inoc.","Mic.Inoc.*Life-stage","Precip.*Life-stage","Precip.* Mic.Inoc. *Life-stage"),"Df"=anova_SG_combin_biomass_orig_model$NumDF,"Resid Df"=anova_SG_combin_biomass_orig_model$DenDF,"F-value"=anova_SG_combin_biomass_orig_model$`F value`,"P-value"=anova_SG_combin_biomass_orig_model$`Pr(>F)`)
...
df_anova_SG_combin_root_shoot_orig_model=data.frame(row.names = c("Microbial Inocula","Precipitation","Life-stage","Precip.*Mic.Inoc.","Mic.Inoc.*Life-stage","Precip.*Life-stage","Precip.* Mic.Inoc. *Life-stage"),"Df"=anova_SG_combin_root_shoot_orig_model$NumDF,"Resid Df"=anova_SG_combin_root_shoot_orig_model$DenDF,"F-value"=anova_SG_combin_root_shoot_orig_model$`F value`,"P-value"=anova_SG_combin_root_shoot_orig_model$`Pr(>F)`)
